...
<figure style="text-align: center;">
  <video width="900" autoplay loop muted playsinline preload="auto">
    <source src="{{ '/assets/video/Supplementary_Video_2.mp4' | relative_url }}" type="video/mp4">
  </video>

  <figcaption style="display: block; margin-top: 10px; text-align: center;">
   Beating cardiomyocytes cultured on a stiff micropatterned substrate.
  </figcaption>
</figure>

<figure style="text-align: center;">
  <video width="900" autoplay loop muted playsinline preload="auto">
    <source src="{{ '/assets/video/Supplementary_Video_3.mp4' | relative_url }}" type="video/mp4">
  </video>

  <figcaption style="display: block; margin-top: 10px; text-align: center;">
   Beating cardiomyocytes cultured on a nonplanar substrate.
  </figcaption>
</figure>
...
<figure style="text-align: center;">
  <video width="900" autoplay loop muted playsinline preload="auto">
    <source src="{{ '/assets/video/Supplementary_Video_4.mp4' | relative_url }}" type="video/mp4">
  </video>

  <figcaption style="display: block; margin-top: 10px; text-align: center;">
   Displacement field generated by beating cardiomyocytes cultured on a micropatterned substrate, reconstructed using a dual-plane TFM–FEA workflow.
  </figcaption>
</figure>
...
<figure style="text-align: center;">
  <video width="900" autoplay loop muted playsinline preload="auto">
    <source src="{{ '/assets/video/Supplementary_Video_6.mp4' | relative_url }}" type="video/mp4">
  </video>

  <figcaption style="display: block; margin-top: 10px; text-align: center;">
   Spatial distribution of strain energy generated by cardiomyocytes cultured on a micropatterned substrate.
  </figcaption>
</figure>
